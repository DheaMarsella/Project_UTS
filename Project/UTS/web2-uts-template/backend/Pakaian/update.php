            ...
            <div class="card-body">
              ...
              <form method="POST" action="proses.php">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input id="nama" value="<?=$row['nama']?>" name="nama" type="text" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input id="ukuran" value=<?=$row['ukuran']?> name="ukuran" type="text" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input id="warna" value=<?=$row['warna']?> name="warna" type="text" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input id="stok" value=<?=$row['stok']?> name="stok" type="text" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input id="harga" value=<?=$row['harga']?> name="harga" type="text" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    ...
                    <select id="tipe_pakaian_id" name="tipe_pakaian_id" class="form-control">
                      ...
                      ?>
                      <option <?php if($row_tipe_pakaian['id'] == $row['tipe_pakaian_id']){echo("selected");}?> value="<?= $row_tipe_pakaian['id'] ?>"><?= $row_tipe_pakaian['tipe'] ?></option>
                      <?php
                      }
                      ?>
                    </select>
